...
setting('global_retraction_amount', 0.0, float, 'expert',   _('Retraction')).setRange(0).setLabel(_("Start retraction amount (mm)"), _("Generic retraction amount used in gcode start"))
...
def replaceTagMatch(m):
	...
	if tag == 'global_retraction_amount':
		return pre + str(getProfileSettingFloat('global_retraction_amount'))
