...
class Engine(object):
	...
	def _engineSettings(self, extruderCount):
		settings = {
			...
			'filamentDiameter2': int(profile.getProfileSettingFloat('filament_diameter2') * 1000),
			'filamentFlow2': int(profile.getProfileSettingFloat('filament_flow2')),
			...
			'retractionAmount2': int(profile.getProfileSettingFloat('retraction_amount2') * 1000) if profile.getMachineSetting('retraction_enable') == 'True' else 0,
			'retractionSpeed2': int(profile.getProfileSettingFloat('retraction_speed2')),
