...
class Engine(object):
	...
	def _engineSettings(self, extruderCount):
		...
		if extruderCount > 1 and (not profile.getPreferenceInt('filament_index') == profile.getPreferenceInt('filament2_index') or (profile.getPreferenceInt('filament_index') == profile.getPreferenceInt('filament2_index') and not profile.getPreference('color_label') == profile.getPreference('color2_label'))) and profile.mergeDone:
