...
class languagePreferencesDialog(wx.Frame):
	def __init__(self, parent):
		super(languagePreferencesDialog, self).__init__(parent, title=_("Preferences"), style=wx.DEFAULT_DIALOG_STYLE|wx.FRAME_FLOAT_ON_PARENT)
