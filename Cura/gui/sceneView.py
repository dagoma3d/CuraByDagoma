...
class SceneView(openglGui.glGuiPanel):
	...
	def _drawMachine(self):
		...
		if int(profile.getMachineSetting('extruder_amount')) == 2:
			machine += '_dual'
		if machine.startswith('DiscoEasy200') or machine.startswith('DiscoVery200') or machine.startswith('Neva') or machine.startswith('Magis') or machine.startswith('Explorer350'):
